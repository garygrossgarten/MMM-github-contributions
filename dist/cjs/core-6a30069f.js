...
const NAMESPACE = 'github-contributions';
...
const patchBrowser = () => {
    ...
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-6a30069f.js', document.baseURI).href));
